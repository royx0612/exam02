<input type="button" value="健康新知" class="tabs" data-tab="1">
<input type="button" value="菸害防治" class="tabs" data-tab="2">
<input type="button" value="癌症防治" class="tabs" data-tab="3">
<input type="button" value="慢性病防治" class="tabs" data-tab="4">
<div class="tab-contents" data-content="1">
  資料來源： 行政院衛生署國民健康局
  發佈日期： 2012 / 10 / 07
...
<div class="tab-contents" data-content="2">
...
<div class="tab-contents" data-content="3">
...
<div class="tab-contents" data-content="4">
  資料來源：中央健康保險局雙月刊第98期
  上稿日期：2012/08/10
  文／游小雯
...
<script>
  $('.tabs').click(function() {
    $('.tab-contents').hide();
    $('.tab-contents[data-content='+$(this).attr('data-tab')+']').show();
  });
  $('.tabs')[0].click();
</script>